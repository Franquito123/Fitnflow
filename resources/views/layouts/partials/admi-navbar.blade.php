...
<head>
    ...
    <!-- Animate.css para la animación zoomInDown -->
...
<style>
    ...
    * {
    ...
    /* Contenedor del logo con efecto neón */
    .logo-wrapper {
        position: relative;
        width: 100px;
        height: 100px;
    ...
    /* Botón de cerrar sesión en el overlay - MEJORADO */
    #logoutButton {
        position: fixed;
        bottom: 20px;
        left: 50%;
...
<body>
    ...
    <!-- Botón Cerrar Sesión (posición fija superior derecha) -->
